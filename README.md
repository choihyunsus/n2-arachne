...
> Weave your codebase into the perfect context for AI ??like Arachne, the greatest weaver of Greek mythology. 
...
?œâ??€ utils/config.ts ??timeout settings live here
??
...
## The Solution ??Arachne Picks Exactly What AI Needs
...
You: "Fix the login timeout bug"
 ...
 ??
?Œâ??€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€??
??Arachne: "I'll find exactly what you need" ??
????
...
??L4 config.ts (frequently accessed, has timeout) ??
????
...
| **4-Layer Assembly** | Smart context paging within token budget |
| **Dependency Graph** | Follows import chains across JS/TS, Python, Rust, Go, **Java** |
| **Backup & Restore** | SQLite online backup with in-backup search |
...
## Stability: 104 Tests, Zero Failures
...
| Null/Empty Input | null, undefined, empty string ??safe return |
...
> **Pro tip**: The best way to install? Just ask your AI agent: *"Install n2-arachne for me."* It knows what to do. 
...
[nton2.com](https://nton2.com) Â· [npm](https://www.npmjs.com/package/n2-arachne) Â· lagi0730@gmail.com
